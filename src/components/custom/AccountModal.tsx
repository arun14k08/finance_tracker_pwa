  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[480px]">
        <DialogHeader>
          <DialogTitle className="text-balance">{initialValues ? "Edit account" : "Add account"}</DialogTitle>
        </DialogHeader>
        ...
        <div className="grid gap-4 py-2">
          ...
          <div className="grid gap-2">
            ...
            <Select
              ...
              onValueChange={(v: AccountType) => setForm((f) => ({ ...f, account_type: v }))}
            >
              <SelectTrigger>
          ...
          <div className="flex items-center justify-between rounded-md border border-border p-3">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">Mark account as active/inactive</p>
            </div>
            <Switch
              id="active"
